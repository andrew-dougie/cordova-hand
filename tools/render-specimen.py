...
font=TTFont(root/'fonts/ttf/CordovaHand-Regular.ttf');cmap=font.getBestCmap();glyphs=font.getGlyphSet()
...
line('ABCDEFGHIJKLMNOPQRSTUVWXYZ',70,567,43,'#fff1d2')
...
paths.append('</svg>');(root/'docs').mkdir(exist_ok=True);(root/'docs/specimen.svg').write_text('\n'.join(paths))
